...
/* instance variable'lar obje'ye bagimlidir ve her obje farkli degerler alabilir
   ...
   eger static variable'in degeri degistirilirse herkes icin degisir  ---> GÜNEŞ MİSALİ
 */
...
public static void main(String[] args) {
    ...
    staticMethod(); //static method static maine call edildi -> astrsal galaksi seyahat
    //non_staticMethod(); //sefil dünyalı galaksiye çıkamaz
}

public static  void staticMethod(){  //->galaksi

    firmaID=2002; //static variable call
    System.out.println("yeni ID : "+firmaID);

}

public void non_staticMethod(){  //->dünyalı
