...
public class C04_DateTimeFormatter {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("ldt = " + ldt); // ldt = 2022-10-25T23:20:26.846159600

        DateTimeFormatter dtf= DateTimeFormatter.ofPattern("dd :) MMMM//YYYY");

        System.out.println("dtf.format(ldt) = " + dtf.format(ldt)); // dtf.format(ldt) = 25 :) Ekim//2022

        DateTimeFormatter dtf1= DateTimeFormatter.ofPattern("hh:mm:ss a"); //-> a ile am-pm

        System.out.println("dtf1.format(ldt) = " + dtf1.format(ldt)); //dtf1.format(ldt) = 11:24:22 ÖS
