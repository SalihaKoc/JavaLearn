...
import P11_depoYonetimi.codeForLifeDepo.Methods;
...
public class Islemler implements Methods {
    ...
    HashMap<Integer, Urunler> urunMap = new HashMap<>(); //HashMap -> urunİd , Urunler
    ...
    public int intTryCatch(int ustlimit, int altlimit) {
        ...
        while (true) {//true oldugu surece
            try {
                ...
                break;//dogru bilgi girisi yaptigi zaman break komutuyl whileden cikilacak
            } catch (
