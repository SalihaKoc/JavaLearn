    ...
    public static void main(String[] args) {
        ...
        if (not>=0 && not<=100){
            ...
            switch (not) {
                ...
                case 3:
                case 4:
                    System.out.println("Aldığınız Not 'D'"); break;
                case 5:
                    System.out.println("Aldığınız Not 'C'"); break;
                case 6:
                case 7:
                    System.out.println("Aldığınız Not 'B'"); break;
                case 8:
                case 9 :
                case 10:
                    System.out.println("Aldığınız Not 'A'"); break;
