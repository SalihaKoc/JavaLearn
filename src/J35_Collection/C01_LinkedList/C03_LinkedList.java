...
public class C03_LinkedList {
    ...
    public static void main(String[] args) {
        ...
        LinkedList<Integer> ll4 = new LinkedList<>(Arrays.asList(1,3,4,6,7,54,34,45));
        System.out.println("ll4 = " + ll4);
        ll4.remove(3); //remove metodun içine integer yazılırsa eleman degil index olarak alınır
                             //burada index=3 olan 6 silinir
        //remove içinde olmayan bir index kullanılırsa IndexBoundsException throw atılır
    }
}
