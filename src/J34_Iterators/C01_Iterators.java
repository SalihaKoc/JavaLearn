...
public class C01_Iterators {
    ...
    public static void main(String[] args) {
        ...
        //l3 elamanlarını ıterator ile :-) set edip  print ediniz-> [Baran :-), Gülsüm :-), Akif :-), Nazım :-)]
        ...
        while (it3.hasNext()) {
            ...
            it3.set(it3.next() + " :-) ");//tekrardaki next() ile elemanı  :-) concat ederk update edildi
            it3.set(it3.next().toUpperCase() + " :-) ");//[BARAN :-) , GÜLSÜM :-) , AKİF :-) , NAZIM :-) ]
        }
        ...
        while (ebikGabık.hasNext()) {
            ebikGabık.set(ebikGabık.next().toUpperCase().charAt(0) + "***");//next()ile geln l4 elamanı ilk harf byk kalan 3 harf*** le set edildi
            ebikGabık.add(l4.toString());//tekrardaki update edilen l3 e l4 add edildi
        }
        System.out.println("Listiterator  set ve add sonrası l3 : " + l3);// [B***, [Serhat , Yakup, Mustafa, Nazlı], G***, [Serhat , Yakup, Mustafa, Nazlı], A***, [Serhat , Yakup, Mustafa, Nazlı], N***, [Serhat , Yakup, Mustafa, Nazlı]]
    }
}
