...
import J25_Encapsulation.encapsulation03.Arac;
...
/*
	 	1) Lambda "Functional Programming"-->mathod(action) kullanan prog dili.
    ...
    public static void printElFunctional( List <Integer> sayi) {
        ...
        sayi. //aksiyona girecek List call
                stream(). //List elmanlarını yukarıdan aşağıya akışa alır
    ...
    */
    ...
    public static void yazdir(int a) { //normal meth tek aksiyonlu -> seed method(tohum) -> refere edilecek method
        System.out.print(a+" ");
    }
