...
public class C08_limit {
    ...
    public static void main(String[] args) {
        ...
        List<String> menu=new ArrayList<>(Arrays.asList("kuşleme","soğanli","trileçe","büryan","küşleme","welemen","bicibici","cacix","kokorec","yağlama","güvec","bicibici","arabaşi","tantuni"));
